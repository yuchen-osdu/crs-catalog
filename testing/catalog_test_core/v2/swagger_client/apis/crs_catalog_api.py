...
class CRSCatalogApi(object):
    ...
    def get_catalog_attributes(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_catalog_attributes(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_catalog_attributes_with_http_info(**kwargs)
        else:
            (data) = self.get_catalog_attributes_with_http_info(**kwargs)
            return data

    def get_catalog_attributes_with_http_info(self, **kwargs):
        """
        Get Catalog Name and Update Dates
        Get the catalog name and last update date
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_catalog_attributes_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_catalog_attributes" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/catalog/attributes', 'GET',
                                        ...
                                        response_type='CatalogAttributes',

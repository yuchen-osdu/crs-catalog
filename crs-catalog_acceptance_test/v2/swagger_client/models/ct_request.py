...
class CTRequest(object):
    ...
    def __init__(self, persistable_reference=None, essence=None):
        """
        CTRequest - a model defined in Swagger
        """
    ...
    def persistable_reference(self):
        """
        Gets the persistable_reference of this CTRequest.
        ...
        :return: The persistable_reference of this CTRequest.
        :rtype: str
        """
    ...
    def persistable_reference(self, persistable_reference):
        """
        Sets the persistable_reference of this CTRequest.
        The persistable reference string, either the essence of the cartographic transform (CT) serialized into a JSON string or an encoded string (version 1).

        :param persistable_reference: The persistable_reference of this CTRequest.
        :type: str
        """
    ...
    def essence(self):
        """
        Gets the essence of this CTRequest.
        The essence Json for the CT. Either the essence or persistableReference must be non-null.

        :return: The essence of this CTRequest.
        :rtype: AnyCTEssence
        """
    ...
    def essence(self, essence):
        """
        Sets the essence of this CTRequest.
        The essence Json for the CT. Either the essence or persistableReference must be non-null.

        :param essence: The essence of this CTRequest.
        :type: AnyCTEssence
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, CTRequest):
            return False

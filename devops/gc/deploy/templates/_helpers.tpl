...
{{- define "crsСatalog.getAutoscaling" -}}
...
{{- define "crsСatalog.minReplicasSpot" -}}
{{- $tier := include "crsСatalog.getTier" . -}}
...
{{- define "crsСatalog.maxReplicasSpot" -}}
{{- $tier := include "crsСatalog.getTier" . -}}

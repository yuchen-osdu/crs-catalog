...
| Name | Description | Type | Default |Required |
|------|-------------|------|---------|---------|
**configmap** | configmap to be used | string | crs-catalog-config | yes
**appName** | name of the app | string | crs-catalog | yes
...
```console
helm install gcp-crs-catalog-configmap .
```
...
```console
helm uninstall gcp-crs-catalog-configmap
```

 ...
 */
public class CTImplResultsTest {
    ...
    public void testConstructor() {
        ...
        CTImpl cartographicTransformImpl = new SingleCTImpl();
        List<CT> cartographicTransformImplList = new ArrayList<>();
        cartographicTransformImplList.add(cartographicTransformImpl);
        CTResults results = new CTResults(cartographicTransformImplList);
        assertTrue(results != null);
        CTResults results2 = new CTResults(cartographicTransformImplList, 0, 1);

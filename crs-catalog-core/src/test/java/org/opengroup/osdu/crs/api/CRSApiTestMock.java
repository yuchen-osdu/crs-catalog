...
public class CRSApiTestMock {
    ...
    public void testSearchCRSes() {
		...
		try {
			...
			CRSResults results;
            results = crsApi.searchCRSes(request, longitudeLeft, latitudeLower, longitudeRight, latitudeUpper, offset, limit, "essence");
            assertEquals(offset, results.getOffset());
    ...
    public void testSearchCTs() {
		...
		try {
			...
			CTResults results;
            results = crsApi.searchCTs(request, longitudeLeft, latitudeLower, longitudeRight, latitudeUpper, offset, limit, "essence");
            assertEquals(offset, results.getOffset());
